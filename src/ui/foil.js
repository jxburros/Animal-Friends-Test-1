...
export const FOIL_ASSIGNMENTS = Object.freeze({
  ...
  bb_clover_1: Object.freeze({ foil: 'full' }),
  ...
  br_toolbox_trade: Object.freeze({ foil: 'artwork' }),
  ...
  ns_flint_0: Object.freeze({ foil: Object.freeze({ mode: 'details', mask: 'assets/art/foil-masks/ns_flint_0-foil.svg' }) }),
