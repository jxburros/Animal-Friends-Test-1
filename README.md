...
`spec/maker_card_set.json` is the contract. [WRITING_A_CHARACTER.md](docs/WRITING_A_CHARACTER.md) is
the process for writing one character's cards, [TOWN_BIBLE.md](docs/TOWN_BIBLE.md) is the shared world
every backstory has to agree with, and
[ANIMAL_FRIENDS_TCG_DESIGN_REFERENCE.md](docs/ANIMAL_FRIENDS_TCG_DESIGN_REFERENCE.md) is the design
